  ...
  <div class="register">
    ...
    <div class="register_cont">
      <div class="login_title">
        <div class="title_name">PAYMENT METHOD</div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="input_cont">
            <!-- <div class="detalis_title">MY ORDERS</div>
             -->
            <div class="account_tab "><a @click="toMyAccount(1)">DASHBOARD</a> </div>
            ...
            <div class="account_tab"><a @click="toMyAccount(8)"
                 class="current_tab">PAYMENT METHOD</a></div>
        ...
        <div class="col-md-8">
          <div class="account_content">
            <div class="content_yet">
              <div class="yet_msg"> <i class="el-icon-mobile"></i> There is no saved payment method.</div>
              <!-- <div class="yet_btn"
                   @cilck='toHome'>VIEW PRODUCT</div> -->
            </div>

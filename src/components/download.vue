  ...
  <div class="register">
    ...
    <div class="register_cont">
      <div class="login_title">
        <div class="title_name">DOWNLOADS</div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="input_cont">
            ...
            <div class="account_tab"><a @click="toMyAccount(6)"
                 class="current_tab">DOWNLOADS</a> </div>
        ...
        <div class="col-md-8">
          <div class="account_content">
            <div class="content_yet">
              <div class="yet_msg"> <i class="el-icon-mobile"></i> No download files are available yet.</div>
              <div class="yet_btn"
